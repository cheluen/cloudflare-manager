 ...
 *
 * Usage:
 *   node scripts/pages.js deploy <project-name> <directory>
 *   node scripts/pages.js list
 *   node scripts/pages.js get <project-name>
 *   node scripts/pages.js delete <project-name>
 *   node scripts/pages.js set-env <project-name> <key> <value>
 *   node scripts/pages.js get-url <project-name>
 *   node scripts/pages.js list-deployments <project-name>
 *
 * Features:
...
async function deployPages(projectName, directory) {
  try {
    ...
    try {
      ...
      const createResponse = await makeApiRequestWithRetry(`/accounts/${accountId}/pages/projects`, {
        method: 'POST',
        body: {
          name: projectName,
...
async function listProjects() {
  try {
    ...
    const response = await makeApiRequestWithRetry(`/accounts/${accountId}/pages/projects`);
...
async function deleteProject(projectName) {
  try {
    ...
    await makeApiRequestWithRetry(`/accounts/${accountId}/pages/projects/${projectName}`, {
      method: 'DELETE',
    });
 ...
 */
async function setEnvironmentVariable(projectName, key, value, environment = 'production') {
  try {
    const accountId = await getAccountId();
    ...
    const getResponse = await makeApiRequestWithRetry(
      `/accounts/${accountId}/pages/projects/${projectName}`
    );
 ...
 */
async function getProjectUrl(projectName) {
  try {
    const accountId = await getAccountId();
...
Usage:
  ...
  node scripts/pages.js get <project-name>
  node scripts/pages.js delete <project-name>
  node scripts/pages.js set-env <project-name> <key> <value> [--env production|preview]
  node scripts/pages.js get-url <project-name>
  node scripts/pages.js list-deployments <project-name>
...
Examples:
  ...
  node scripts/pages.js list-deployments my-app
